  ...
  return (
    <div className='max-w-[1440px] mx-auto w-full text-white font-roboto md:py-20 py-10 text-center px-5'>
        <div className='md:w-[60%] w-full mx-auto flex-col flex gap-8'>
            <h1 className='font-extrabold sm:text-[56px] text-[40px] md:text-7xl'>
            ...
            <div className='flex font-medium text-xl justify-center gap-8'>
              <button className="bg-Purple-600 hover:bg-purple-500 px-4 py-4 rounded-[8px] w-[168px]">
          <span>Join Now</span>
        </button>

        <button className="border hover:bg-Purple-600 hover:border-transparent ease-in-out transition-all px-4 py-4 rounded-[8px] w-[168px]">
          <span>View Demo</span>
        </button>
            </div>
        </div>
